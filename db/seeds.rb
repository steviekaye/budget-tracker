...
snacks = Subcategory.find_by(name: 'Food - snacks')
clothing = Subcategory.find_by(name: 'Clothing')
rent = Subcategory.find_by(name: 'Rent')
groceries = Subcategory.find_by(name: 'Food - flat')
expenses = Subcategory.find_by(name: 'Household expenses')
books = Subcategory.find_by(name: 'Books/records/etc')

if Purchase.none?
  Purchase.create(date: 1.month.ago, description: 'Avocado', amount: 4.5, payee: 'Evil Dairy',
                  purchaser: User.first, purchasee: User.first, subcategory: snacks)
  ...
  Purchase.create(date: 1.month.ago(1.weeks.since), description: 'Summer hat', amount: 23.00, payee: 'Paperbag Princess',
                  purchaser: User.first, purchasee: User.first, subcategory: clothing)
  ...
  Purchase.create(date: 2.months.ago(1.days.since), description: 'Cassette', amount: 10.00, payee: 'fruit juice parade',
                  purchaser: User.second, purchasee: User.second, subcategory: books)
  ...
  Purchase.create(date: 4.months.ago(5.days.ago), description: 'Rent', amount: 70.00, payee: '9 Holloway Rd',
                  purchaser: User.second, purchasee: User.third, subcategory: rent)
  Purchase.create(date: 4.months.ago, description: 'Household expenses', amount: 50.00, payee: '9 Holloway Rd',
                  purchaser: User.second, purchasee: User.third, subcategory: expenses)
  Purchase.create(date: 4.months.ago, description: 'Food - flat', amount: 40.00, payee: '9 Holloway Rd',
                  purchaser: User.second, purchasee: User.third, subcategory: groceries)
